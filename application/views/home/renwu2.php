...
<div class="fabu_box2">
<form id="all-data" method="post"  action="/home/User/SaveRenwu">
   <ul class="cont">
   		<li>
			...
			<div class="addvalue">
			   <ul>
                    ...
                    <li>
                 	...
                 	<li>
						<div class="name">完整浏览到底：<img src="/wanjia/static/images/public/new.png" style="left: -15px;"></div>
