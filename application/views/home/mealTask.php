...
<li>
	<div class="name">
		...
		<div class="value">
		<select id="ddlMealType" name="ddlMealType">
		<option value="1">普通套餐任务</option>
		...
		普通套餐任务，
		<span>4</span>
		星星基础消耗，来路套餐任务在此基础上再增加
		<span>1</span>
		星星基础消耗。
	</div>
</li>
<li class="limeal" style="display: none;margin-left: 40px;">
	<div class="name"></div>
...
<li class="visitWay visitWay-1 com-hidden">
...
<li class="visitWay visitWay-1 com-hidden" style="height:65px;">
...
<script>
	...
	function beforeSubmit1(){
		...
		ddlMealType = $("#ddlZGAccount").val();
		if(ddlMealType==1){
			xin=xin+400;
		}else if(ddlMealType ==3 ){
			xin=xin+500;
		}
