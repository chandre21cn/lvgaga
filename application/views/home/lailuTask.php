...
<form action="/home/User/SavelailuTash" id="all-data" method="post" >
<div class="fabu_box2">
   <ul class="cont">
   		<li>
...
<li>
	...
	<div class="exp">就是您想提升信誉的拍拍帐号，接任务的朋友用来确认您的身份。<a href="/#bindSeller">绑定掌柜</a></div>
</li>

<li style="margin-left: 40px;">
	<div id="divtype" style="float:left;width:340px;">
	<input id="rshop" type="radio" checked="checked" name="visitWay" value="1">
	搜店铺&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input id="rgoods" type="radio" name="visitWay" value="2">
	搜商品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input id="rcredits" type="radio" name="visitWay" value="3">
	信用评价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input id="rtrains" type="radio" name="visitWay" value="4">
	直通车
	</div>
...
<li class="visitWay visitWay-1">
	...
	<div class="value">
	<input id="txtDes" class="txt" type="text" style="width:182px;color:#f50;" maxlength="100" name="txtDes">
	</div>
...
<li>
	...
	<input id="url-upfile-1" type="text" title="没有图片请保留空" readonly="" style="width:206px;height:20px" maxlength="150" name="PhotoUrl">
	</div>
	<div class="exp" style="float:left;">
		<span style="display:none" id="imgtmp">
		<img src="" id="imgtmpsrc" width=100 height=100 ><input type="button" id="rebu" value="重新上传">
		</span>
		<span class="uploadImg" style="float:left;">
	        <input  id="fileupload" type="file" name="mypic" class="file" size="25" style="margin-left:-232px;margin-top:0px;">

	        <input  class="button" value="选择本地图片并上传">
	      </span>
	      <span id="info-upfile-1" class="upload-info green"></span>
	</div>
	<input type="hidden" name='imgsrc' value="" id='srcimg' />
	<script>
	$("#rebu").click(function(){
		$("#url-upfile-1").val('');
        $("#srcimg").val('');
...
$(function () {
    $("#fileupload").wrap("<form id='myupload' action='<?php echo  site_url('home/Dating/UploadImage') ?>' method='post' enctype='multipart/form-data'></form>");
    $("#fileupload").change(function(){ //选择文件
        ...
        $("#myupload").ajaxSubmit({
            ...
            success: function(data) { //成功
                ...
                $("#imgtmpsrc").attr('src',"/"+data.pic);
                $("#url-upfile-1").val(data.name);
                $("#imgtmp").css('display','block');
            },
...
<li>
	...
	<div class="value long">
	<input id="txtGoodsUrl" class="txt" type="text" placeholder="http://" style="width:100%;" name="txtGoodsUrl">
	</div>
...
<li>
	...
	<div class="value">
	<input id="txtPrice" class="txt" type="text" value="0" style="width:152px;color:#f50;" name="txtPrice">
	  元<p style="padding-top:3px;"><input id="chssp" type="checkbox" style="margin-left:-2px;+margin-left:-5px;" value="1" name="chssp"> <span style="color:#999">打折类物品，取消商品价格限制</span></p>
	</div>
	<div class="exp">
			   ...
			   <ul>
                	...
                	-->
                      ...
                      <li>
                          ...
                          <div class="value long">
                          	<input id="cbxIsMsg" type="checkbox" name="cbxIsMsg" value="1">
                            <textarea name="txtMessage" id="txtMessage">此处填写您希望接手人对您的任务商品的评语内容，例如：“掌柜妹妹很热情，发货速度很快，商品拿到了,感觉比图片上还要漂亮”。请不要填写“请带字好评”等引导的文字
                            </textarea>
                          </div>
                          <div class="exp">您可以规定接手方在拍拍交易好评时填写规定的内容。额外支付的<em>0.1</em>个星星将奖励给接手方</div>
                      </li>
                    ...
                    <li>
                      <div class="name">货比三家：<img src="/wanjia/static/images/public/new.png"></div>
                      <div class="value longest">
                        <div id="divFMCount" style="margin-bottom:5px;">
                        	<div>
                            	<label><input type="checkbox" value="1" id="isCompare" name="isCompare"></label>
  								<input type="radio" name="contrast" value="1">
  								<span>货比一家</span>
  								<input type="radio" name="contrast" value="2">
  								<span>货比二家</span>
  								<input type="radio" name="contrast" value="3">
  								<span>货比三家</span>
  							</div>
                        </div>
                        <fieldset class="fieldset">
                        	<legend>第一个搜索设置</legend>
							<p><span style="float: left; height: 22px;line-height: 25px">商品地址：</span><input placeholder="需要进行货比的商品网址" name="contrastUrl_1" type="text" class="txt" maxlength="200"></p>
  							<p><span style="float: left; height: 22px;line-height: 25px">搜索提示：</span><input placeholder="此处填写提示信息，说明任务商品在关键字搜索结果列表中的位置" name="contrastTip_1" type="text" class="txt" maxlength="100"></p>
  						</fieldset>
  						<fieldset class="fieldset">
                        	<legend>第二个搜索设置</legend>
							<p><span style="float: left; height: 22px;line-height: 25px">商品地址：</span><input placeholder="需要进行货比的商品网址" name="contrastUrl_2" type="text" class="txt" maxlength="200"></p>
  							<p><span style="float: left; height: 22px;line-height: 25px">搜索提示：</span><input placeholder="此处填写提示信息，说明任务商品在关键字搜索结果列表中的位置" name="contrastTip_2" type="text" class="txt" maxlength="100"></p>
  						</fieldset>
  						<fieldset class="fieldset">
                        	<legend>第三个搜索设置</legend>
							<p><span style="float: left; height: 22px;line-height: 25px">商品地址：</span><input placeholder="需要进行货比的商品网址" name="contrastUrl_3" type="text" class="txt" maxlength="200"></p>
  							<p><span style="float: left; height: 22px;line-height: 25px">搜索提示：</span><input placeholder="此处填写提示信息，说明任务商品在关键字搜索结果列表中的位置" name="contrastTip_3" type="text" class="txt" maxlength="100"></p>
  						</fieldset>

                        <div class="exp">每货比一家需额外支付<em>0.5</em>个星星</div>
                      </div>
                 	</li>
                    ...
                    <li>
                      <div class="name">店内浏览商品：<img src="/wanjia/static/images/public/new.png" style="left: -15px;"></div>
                      <div class="value longest">
                        <div id="divFMCount" style="margin-bottom:5px;">
                        	<div>
                            	<label><input type="checkbox" value="1" id="shopBrGoods" name="shopBrGoods"></label>
                            	<input type="radio" name="lgoods" value="1"> 额外浏览1个商品
                            	<input type="radio" name="lgoods" value="2"> 额外浏览2个商品
                            	<input type="radio" name="lgoods" value="3"> 额外浏览3个商品
                        	</div>
                        </div>
                        <div class="exp">每额外浏览一个商品需要<em>0.3</em>个星星</div>
                      </div>
                 	</li>
...
<script>
	...
	function beforeSubmit1(){
		...
		if($("#isCompare").is(":checked")){
			isCompare=1;
			stprice = $('input:radio[name="contrast"]:checked').val();
			if(IsPlusNumeric(stprice)){
				xin = xin + stprice*50;
			}
		}
		cbxIsSetTime2 =0;
